...
__@sec-probmodels: Probability Models: How Do I Get a Sampling Distribution?__
...
__@sec-param-estim: Estimating a Parameter: Which Population Values Are Plausible?__

(ref:conflevelSPSS) Setting the confidence level in SPSS.

* Video @fig-SPSSconflevel: (ref:conflevelSPSS)

__@sec-hypothesis: Testing a Null Hypothesis: Am I Right or Am I Wrong?__
...
__@sec-power: Which Sample Size Do I Need? Power!__

(ref:cohendtitle) Obtaining Cohen's _d_ with SPSS.

* Video @fig-cohend: (ref:cohendtitle)

__@sec-anova: Moderation with Analysis of Variance__
...
__@sec-moderationcat: Regression Analysis And A Categorical Moderator__
...
__@sec-moderationcont: Regression Analysis With A Numerical Moderator__
...
For an instruction and exercises on one-way analysis of variance, see Figure @fig-SPSS1way and @sec-onewaySPSS. For two-way analysis of variance, see @sec-twowaySPSS (instructions and exercises).
