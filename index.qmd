...
# SPSS basics {#spss-basics .unnumbered}
...
In communication science the compute funciont is often used to combine seperate questionaire items into a single scale score. For example, if you have a 5-item scale measuring vaccine acceptance, you could use the `MEAN` or `SUM` function to calculate the new scale score across those items and create a new variable called `acceptance_scale`. This new variable can then be used in subsequent analyses.
