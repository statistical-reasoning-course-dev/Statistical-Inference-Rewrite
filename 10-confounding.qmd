...
::: {#fig-mediation-multipleregression}
...
::: {#fig-mediation-indirectcorrelation}
...
:::{#fig-reinforcement1}
```{r reinforcement1, echo=FALSE, fig.pos='H', fig.align='center',  fig.asp=0.3}
library(ggplot2)
# Create coordinates for the variable names.
...
:::{#fig-reinforcement2}
```{r reinforcement2, echo=FALSE, fig.pos='H', fig.align='center', fig.asp=0.3}
library(ggplot2)
# Create coordinates for the variable names.
variables <- data.frame(x = c(0.3, 0.38, 0.5, 0.62, 0.7, 0.5), 
                        y = c(.1, .2, .3, .2, .1, .1),
