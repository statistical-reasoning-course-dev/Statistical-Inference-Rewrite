...
5. If categorical, how many levels does it have?
6. How is the data sampled
...
Once you have identified the variables, the interactive flow chart in @fig-flowchart helps you to identify the right statistical test. A [PDF of the flow chart is available for download here](https://shklinkenberg.github.io/statistical-test-selection/mermaid_flowchart_pdf.pdf). The flow chart is an extended version of the flowchart by @field2024spss _Discovering Statistics_.
