...
![NHST decision table.](figures/decision_table.svg){width=300 #fig-decisiontable fig-align="left"}
...
The first step in the Neyman Pearson approach is to set the desired type I error rate, also known as the significance level, $\alpha$. This is the probability of rejecting the null hypothesis when it is in reality true. In the $2 \times 2$ decision table in @fig-decisiontable, this corresponds to the top left quadrant.
