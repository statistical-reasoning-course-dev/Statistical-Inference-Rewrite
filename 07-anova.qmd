...
Elaboration Likelihood Model (ELM; Petty & Cacioppo, 1980) suggests that people with higher ability to process information are more persuaded by message quality than cues like authority. In other words, people with low health literacy might sooner accept information from a source with controlling language than people with high health literacy. In the ELM health literacy corresponds with the factor ''ability'' (@ XXX).
