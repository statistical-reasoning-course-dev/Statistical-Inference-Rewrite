...
Elaboration Likelihood Model (ELM; Petty & Cacioppo, 1980) suggests that people with higher ability to process information are more persuaded by message quality than cues like authority. In the ELM health literacy can correspond with the factor 'ability'. In other words, people with low health literacy might sooner accept information from a source with controlling language than people with high health literacy (@RefWorks:5051).
