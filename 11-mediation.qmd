...
:::{#fig-causaldiagram}
```{r causaldiagram, echo=FALSE, fig.pos='H', fig.align='center', fig.asp=0.3}
library(ggplot2)
...
rm(variables)
```
Causal diagram for the effects of age and interest in politics on newspaper reading time.
:::
...
:::{#fig-causaldiagram2}
```{r causaldiagram2, echo=FALSE, fig.pos='H', fig.align='center', fig.asp=0.3}
library(ggplot2)
# Create coordinates for the variable names.
...
rm(variables)
```
Causal diagram for the effect of age on newspaper reading time mediated by interest in politics and news site use.
:::
...
:::{#fig-mediation-regression}
```{r mediation-regression, echo=FALSE, fig.pos='H', fig.align='center', out.width="640px", screenshot.alt = "figures/mediation-regression.png"}
...
```
Path diagram with unstandardized effect sizes and their 95% confidence intervals.
:::
...
:::{#fig-pathdiagram-unstandardized}
```{r pathdiagram-unstandardized, echo=FALSE, fig.pos='H', fig.align='center', out.width="640px", screenshot.alt = "figures/pathdiagram-unstandardized.png"}
...
:::{#fig-mediationparallel}
```{r mediationparallel, echo=FALSE, fig.pos='H', fig.align='center', fig.asp=0.6, fig.show="hold", out.width="50%"}
# Single mediation.
# Create coordinates for the variable names.
variables <- data.frame(x = c(0.3, 0.5, 0.7), 
                        y = c(.2, .6, .2),
...
rm(variables)
```
Causal diagrams for single (left) and parallel mediation (right).
:::
...
:::{#fig-mediationserial}
```{r mediationserial, echo=FALSE, fig.pos='H', fig.align='center', fig.asp=0.3}
# Create coordinates for the variable names.
...
rm(variables)
```
Causal diagram for serial mediation.
:::
...
:::{#fig-causaldiagram3}
```{r causaldiagram3, echo=FALSE, fig.pos='H', fig.align='center', fig.asp=0.3}
# Create coordinates for the variable names.
variables <- data.frame(x = c(0.3, 0.5, 0.7), 
                        y = c(.1, .3, .1),
                        label = c("Age", "Pol.Interest", "Reading Time"))
...
rm(variables)
```
Causal diagram for the effects of age and interest in politics on newspaper reading time: unstandardized estimates with 95% confidence intervals.
:::
...
:::{#fig-causaldiagram4}
```{r causaldiagram4, echo=FALSE, fig.pos='H', fig.align='center', fig.asp=0.3}
# Create coordinates for the variable names.
...
rm(variables)
```
Causal diagram for  interest in politics as mediator between age and newspaper reading time with education as covariate.
:::
...
:::{#fig-results-pathdiagram}
```{r results-pathdiagram, echo=FALSE, fig.asp=0.5, fig.pos='H', fig.align='center', screenshot.alt = "figures/results-pathdiagram.png"}
# Load data.
readers <- haven::read_spss("data/readers.sav")
# Create effect sizes.
model_3 <- lm(newssite ~ age + education + polinterest, data = readers)
...
```
Unstandardized direct effects for a path model with one mediator and two covariates.
:::
...
:::{#fig-causaldiagram5}
```{r causaldiagram5, echo=FALSE, fig.pos='H', fig.align='center', fig.asp=0.3}
# Create coordinates for the variable names.
...
rm(variables)
```
Causal diagram for interest in politics as mediator between age and newspaper reading time with sex as moderator of the effect of age on interest in politics.
:::
