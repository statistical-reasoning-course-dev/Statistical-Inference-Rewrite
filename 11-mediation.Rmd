...
```{block2, type='rmdquestion'}
3. Adjust the correlations in such a way that the effect of age on reading time is zero. In this situation, we say that the effect is fully mediated. [<img src="icons/2answer.png" width=115px align="right">](#answer9.5.3)
```
...
```{block2, type='rmdquestion'}
2. How many indirect effects does age have on media literacy in Figure \@ref(fig:mediationserial2)? And how many indirect effects does sex (variable _Girl_) have on media literacy? [<img src="icons/2answer.png" width=115px align="right">](#answer11.8.2)
```
