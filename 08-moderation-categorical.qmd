...
As described above regression analysis with categorical moderators require dummy variables. It is always possible to manually create dummy variables for categorical moderators. However, the PROCESS add on for SPSS is a very useful tool for estimating moderation models with categorical moderators. It is easy to use and it automatically creates interaction terms and dummy variables for you. The add on is free and can be downloaded from [Andrew Hayes' website](http://www.processmacro.org/download.html).

#### PROCESS with 2 level moderator
...
#### SPSS Instructions A Dichotomous or Categorical 
