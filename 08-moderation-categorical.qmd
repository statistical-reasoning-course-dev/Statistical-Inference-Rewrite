...
The interaction variable must be included together with the original predictor and moderator variables, see Equation @eq-intvar. This is also visible in the statistical diagram (@fig-moderator-statistical) for moderation in a regression model.
