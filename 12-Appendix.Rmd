...
The flow chart in figure \@ref(fig:choice-diagram-copy) helps you select the appropriate statistical test based on the type of dependent and independent variables. 
...
__Chapter \@ref(probmodels): Probability Models: How Do I Get a Sampling Distribution?__
...
* Video \@ref(fig:SPSSbootstrap1): (ref:bootstrap1SPSS)
* Video \@ref(fig:SPSSbootstrap2): (ref:bootstrap2SPSS)
* Video \@ref(fig:SPSSExact1): (ref:Exact1SPSS)
* Video \@ref(fig:SPSSExact2): (ref:Exact2SPSS)

__Chapter \@ref(param-estim): Estimating a Parameter: Which Population Values Are Plausible?__

(ref:conflevelSPSS) Setting the confidence level in SPSS.

* Video \@ref(fig:SPSSconflevel): (ref:conflevelSPSS)

__Chapter \@ref(hypothesis): Testing a Null Hypothesis: Am I Right or Am I Wrong?__
...
* Video \@ref(fig:SPSSbinomial): (ref:binomialSPSS)
* Video \@ref(fig:SPSSchisq1): (ref:chisq1SPSS)
* Video \@ref(fig:SPSS1mean): (ref:1meanSPSS)

__Chapter \@ref(power): Which Sample Size Do I Need? Power!__

(ref:cohendtitle) Obtaining Cohen's _d_ with SPSS.

* Video \@ref(fig:cohend): (ref:cohendtitle)

__Chapter \@ref(anova): Moderation with Analysis of Variance__
...
* Video \@ref(fig:SPSS1way): (ref:1waySPSS)
* Video \@ref(fig:SPSS2way): (ref:2waySPSS)
* Video \@ref(fig:SPSSeta2): (ref:eta2SPSS)

__Chapter \@ref(moderationcat): Regression Analysis And A Categorical Moderator__
...
* Video \@ref(fig:SPSSregsimple): (ref:regsimpleSPSS)
* Video \@ref(fig:SPSSregdummy2): (ref:regdummy2SPSS)
* Video \@ref(fig:SPSSregdummy): (ref:regdummySPSS)
* Video \@ref(fig:SPSSregassumpt): (ref:regassumptSPSS)
* Video \@ref(fig:SPSSregpred): (ref:regpredSPSS)
* Video \@ref(fig:SPSSregcatmod): (ref:regcatmodSPSS)
* Video \@ref(fig:SPSSregmodlines): (ref:regmodlinesSPSS)
* Video \@ref(fig:SPSSregSupport1): (ref:regSupport1SPSS)

__Chapter \@ref(moderationcont): Regression Analysis With A Numerical Moderator__
...
* Video \@ref(fig:SPSSregcenter): (ref:regcenterSPSS)
* Video \@ref(fig:SPSSreglines2): (ref:reglines2SPSS)
* Video \@ref(fig:SPSSregSupport2): (ref:regSupport2SPSS)

__Chapter \@ref(confounder): Regression Analysis And Confounders__

(ref:regconfoundSPSS) Identifying confounders with regression in SPSS.

* Video \@ref(fig:SPSSregconfound): (ref:regconfoundSPSS)

__Chapter \@ref(mediation): Mediation with Regression Analysis__
...
* Video \@ref(fig:SPSSmediatpar): (ref:mediatparSPSS)
* Video \@ref(fig:SPSSmediatserial): (ref:mediatserialSPSS)
* Video \@ref(fig:SPSSmediatcov): (ref:mediatcovSPSS)
* Video \@ref(fig:SPSSpath): (ref:pathSPSS)
...
* Video \@ref(fig:SPSSLevene): (ref:SPSSLevene)
* Video \@ref(fig:SPSSTindep): (ref:SPSSTindep)
* Video \@ref(fig:SPSSTpaired): (ref:SPSSTpaired)
* Video \@ref(fig:SPSScorrelation): (ref:SPSScorrelation)
* Video \@ref(fig:SPSSchisqcross): (ref:SPSSchisqcross)
...
For a binomial test, see the video in Figure \@ref(fig:SPSSbinomial). A one-sample chi-squared test is explained in the video of Figure \@ref(fig:SPSSchisq1).
...
The one-sample _t_ test in SPSS is explained in Figure \@ref(fig:SPSS1mean).
...
```{block2, type='rmdquestion'}
3. Is willingness to donate at the end of the campaign higher for those who remember the campaign than for those who do not remember it? Use the data in [donors.sav](https://shklinkenberg.github.io/Statistical-Inference/data/donors.sav). [<img src="icons/2answer.png" width=115px align="right">](#answer10.3)
```
...
```{block2, type='rmdquestion'}
5. In the population of all consumers, is brand awareness linked to exposure to advertisements for the brand? Use [consumers.sav](https://shklinkenberg.github.io/Statistical-Inference/data/consumers.sav) to answer this question. [<img src="icons/2answer.png" width=115px align="right">](#answer10.5)
```
...
## Cohen's _d_ calculatons {#CohenCalculations}
