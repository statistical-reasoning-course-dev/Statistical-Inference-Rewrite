...
In the candy weight example, we first need to know the mean of population candy weight, then we can construct a theoretical probability distribution of sample means (so-called sampling distribution of sample means). But we do not know the population mean; we want to estimate it.
...
### Reverse reasoning from one sample mean  {#imag-pop-values}
