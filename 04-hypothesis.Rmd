...
The Neyman Pearson approach considers the following:
...
In figure \@ref(fig:expected-value) you can set the parameter values to .5 and .2 and see what the discreet probability distribution looks like.
...
1. Which statistics are addressed in the examples of research hypotheses above? [<img src="icons/2answer.png" width=115px align="right">](#answer4.2.1){.buttonToAnswer}
```
...
```{block2, type='rmdquestion', echo = Qch4}
2. Figure \@ref(fig:nullsampling) shows the hypothesized population mean and the associated sampling distribution. Formulate the null hypothesis represented by this figure and explain why the hypothesized value is in the middle of the sampling distribution. [<img src="icons/2answer.png" width=115px align="right">](#answer4.2.2){.buttonToAnswer}
```

<A name="question4.2.3"></A>
```{block2, type='rmdquestion', echo = Qch4}
3. If the null hypothesis is true, what does the sampling distribution tell us? [<img src="icons/2answer.png" width=115px align="right">](#answer4.2.3){.buttonToAnswer}
```

<A name="question4.2.4"></A>
```{block2, type='rmdquestion', echo = Qch4}
4. In the second step of hypothesis testing (click on *Step 2*), we formulate a decision rule for rejecting the null hypothesis. The decision rule is graphically represented by the blue tails in Figure \@ref(fig:nullsampling). What is the probability that we draw a sample that is part of the blue tails? Note that this probability is called the *significance level* of the test. [<img src="icons/2answer.png" width=115px align="right">](#answer4.2.4){.buttonToAnswer}
```

<A name="question4.2.5"></A>
```{block2, type='rmdquestion', echo = Qch4}
5. If a sample is part of the blue tails, we reject the null hypothesis. We say that the test is statistically significant. How low or high must the sample mean be to have a statistically significant test result? [<img src="icons/2answer.png" width=115px align="right">](#answer4.2.5){.buttonToAnswer}
```

<A name="question4.2.6"></A>
```{block2, type='rmdquestion', echo = Qch4}
6.  Go to Step 3 in the figure, which adds the sample. Is the test statistically significant for this sample? Explain your answer. Take some more samples to practice recognizing statistically significant results.[<img src="icons/2answer.png" width=115px align="right">](#answer4.2.6){.buttonToAnswer}
```

<A name="question4.2.7"></A>
```{block2, type='rmdquestion', echo = Qch4}
7. Go to Step 4 in the figure, which shows the decision on the null hypothesis. Is it always possible to formulate a null hypothesis such that the sample mean is statistically significant? Take some new samples and change the value of the null hypothesis to check your answer. [<img src="icons/2answer.png" width=115px align="right">](#answer4.2.7){.buttonToAnswer}
```
...
```{block2, type='rmdquestion', echo = Qch4}
8. What does the red number next to the solid red vertical line represent in Figure \@ref(fig:twosided)? [<img src="icons/2answer.png" width=115px align="right">](#answer4.2.8){.buttonToAnswer}
```

<A name="question4.2.9"></A>
```{block2, type='rmdquestion', echo = Qch4}
9. What is the relation between the red number next to the solid red vertical line and the two-sided _p_ value reported in the figure? Pay attention to the dashed red vertical line in your answer. [<img src="icons/2answer.png" width=115px align="right">](#answer4.2.9){.buttonToAnswer}
```

<A name="question4.2.10"></A>
```{block2, type='rmdquestion', echo = Qch4}
10. Is the test on average media literacy statistically significant in the initial situation of Figure \@ref(fig:twosided)? If so, at which significance level? Use the rejection region, the number to the vertical red line, and the two-sided _p_ value to motivate your answer. [<img src="icons/2answer.png" width=115px align="right">](#answer4.2.10){.buttonToAnswer}
```

<A name="question4.2.11"></A>
```{block2, type='rmdquestion', echo = Qch4}
11. What happens to the two-sided _p_ value if you change the hypothesized population mean? [<img src="icons/2answer.png" width=115px align="right">](#answer4.2.11){.buttonToAnswer}
```
