...
```{block2, type='rmdquestion'}
1. Use the data set [households.sav](https://shklinkenberg.github.io/Statistical-Inference/data/households.sav) to test the research hypothesis that the TV station reaches 50 per cent of all households in the population. [<img src="icons/2answer.png" width=115px align="right">](#answer4.8.1)
```
...
```{block2, type='rmdquestion'}
5. Use the data set [children.sav](https://shklinkenberg.github.io/Statistical-Inference/data/children.sav) to test the hypothesis that average parental supervision of the child's media use is 5.5 (on a scale from 1 to 10) in the population. [<img src="icons/2answer.png" width=115px align="right">](#answer4.8.5)
```
