...
The Neyman Pearson approach is about choosimg your desired probability of making correct and incorrect decisions, setting up the right conditions for this, and making a decision. It considers the following:

* $H_0$
* The true alternative $H_A$
* The true effect size
* Desired type I error ($\alpha$)
* Desired Power ($1 - \beta$)
* Required sample size for the desired type I error and Power
* Data collection with the appropriate sample size
* Test statistic
* The $p$-value
* Conclusion
...
This is essentially what meta analysis analysis is about. Collecting effect sizes from multiple studies and combining them to get an indication of the true effect size. 
